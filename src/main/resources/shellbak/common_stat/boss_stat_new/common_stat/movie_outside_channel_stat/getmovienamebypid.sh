...
if __name__=="__main__":
    ...
    filepathx='/home/boss/shell/hive/common_stat/boss_stat_new/common_stat/movie_outside_channel_stat/data/movie_outer_channel_result.'+x
    file_object = open(filepathx, 'w+')
    lineNum=0
    pathx='/home/boss/shell/hive/common_stat/boss_stat_new/common_stat/movie_outside_channel_stat/data/movie_outer_channel_temp.'+x
