CREATE TABLE `dm_boss.t_letv_vip_order_all_temp`(
  ...
  `order_desc` map<string,string> COMMENT '订单描述信息', 
  ...
  `version` string COMMENT '会员版本，来自V1还是V2版本', 
  `pay_version` string COMMENT '支付的版本', 
  `country` int, 
